...
class SimpleFraudDetector:
    ...
    def detect_fraud(self, df):
        ...
        try:
            ...
            df.loc[df['anomaly_score'] >= 0.5, 'risk_label'] = 'B'  # Medium risk
            df.loc[df['anomaly_score'] == 1, 'risk_label'] = 'A'  # High risk
            
            # Calculate confidence score
            df['confidence_score'] = np.abs(df['amount_zscore']) / 10  # Simple confidence metric
